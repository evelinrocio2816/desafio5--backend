...
//res.cookie("Airbag", "mi banda de rock").send("Amo a los Sardellis")
//
//})
//
//app.get("/borrarcookie", (req,res)=>{
//  res.clearCookie("Airbag", "mi banda de rock").send("Cookie eliminada")
//
//})
//
////                      LOGIN DE USUARIO 
...
//  res.send("guardamos el usuario por medio de querys")
//})
//
...
//}
// res.send("no existe el  usuario registrado")
//})
//
////////////////////////////////////////////////////////////////INICIO EL SERVIDOR//////////////////////////////////////////////////////
